...
class NoWDataset(Dataset):
    def __init__(self, data_file, split='all', train_ratio=0.8, crop_size=224, scale=1.6, dist_path=None):
        self.scale = scale
...
class SubjectBasedNoWDataSet(NoWDataset):
    ...
    def __getitem__(self, index):
        ...
        relevant_lines = [line for line in self.data_lines if subject in line]
